...
tests = %w[new_games_116_test five_games_regression_test five_games_followup_test five_games_207_feedback_test five_games_ui_test monopoly_regional_test new_games_complete_match_test monopoly_uno_poker_208_feedback_test monopoly_management_ui_test monopoly_poker_bot_208_feedback_test uno_interceptions_test uno_straights_test uno_wild_colour_choice_test makao_penalty_target_test monopoly_property_messages_test monopoly_trade_compact_test game_event_transport_limit_test game_sounds_test game_messages_after_211_test game_messages_ui_test game_messages_translation_test monopoly_auction_and_bankruptcy_test]
tests.each do |name|
  puts "Running #{name}"
