    ...
    def rule_sections
      [
        ...
        rule_section(:controls, _("Selecting, bidding and paying"),
          ...
          _("During payment, Z and Shift+Z visit cards that can form a legal payment. They do not select a packet or pay automatically. Escape clears a prepared packet."))
      ]
    end
