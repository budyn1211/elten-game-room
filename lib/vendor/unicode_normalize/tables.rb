...
# Game Room vendors the complete Unicode 17.0.0 normalization tables below.
# Unlike Ruby's internal copy, these do not require the host's Unicode tables
# or Encoding::UNICODE_VERSION (which is absent on some ELTEN runtimes).

module UnicodeNormalize  # :nodoc:
  TABLE_UNICODE_VERSION = "17.0.0".freeze
