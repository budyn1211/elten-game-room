...
# Game Room compatibility: use bundled tables regardless of host Unicode
# version and explicit block parameters supported by older ELTEN runtimes.
...
module UnicodeNormalize  # :nodoc:
  ...
  def self.canonical_ordering_one(string)
    ...
    chars.each_with_index do |char, i|
      ...
      if ccc == 0
        unordered.sort!.each { |entry| result << chars[entry % n] }
        unordered.clear
        result << char
      else
        unordered << ccc * n + i
