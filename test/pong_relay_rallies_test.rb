...
[
  ...
  begin
    ...
    puts "PASS scheduled #{players.length}-human relay: teams=#{teams.inspect}, arcade=#{arcade}, owner_observer=#{!players.include?('Alice')}, eight rallies/all server seats, jitter 20-220ms, RPC 120ms, 1/7 positions dropped, owner UI gaps"
  ensure
    rig.close
  end
end
