...
puts "PASS binary rules UI: #{windows} document windows for #{EltenGameRoom::GAME_REGISTRY.ids.length} games, EN/PL and English fallback beside a non-English host, with native dictionary compatibility"
