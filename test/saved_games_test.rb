...
%w[four_in_a_row tic_tac_toe chess checkers reversi ludo spades farkle ninety_nine tysiac monopoly yahtzee uno poker makao].each do |name|
...
types = %w[FourInARow TicTacToe Chess Checkers Reversi Ludo Spades Farkle NinetyNine Tysiac Monopoly Yahtzee Uno Poker Makao]
types.each do |type|
